        ...
        <section id="about" className="py-20 text-gray-200">
            <div className="container mx-auto px-4">
                ...
                <p className="text-lg leading-relaxed">
                    In my spare time, I like to explore new technologies, contribute to open-source
                    projects, and write about my experiences in the tech industry. I'm always
                    excited to take on new challenges and work on meaningful projects.
                </p>
